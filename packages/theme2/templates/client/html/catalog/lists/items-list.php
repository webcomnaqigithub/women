						...
						<noscript>
							<div class="media-item" itemscope itemtype="http://schema.org/ImageObject">
								<img alt="<?= $enc->attr( $mediaItem->getName() ) ?>"
									src="<?= $enc->attr( $this->content( 'aimeos/' . $mediaItem->getPreview(), $mediaItem->getFileSystem() ) ) ?>"
									srcset="<?= $enc->attr( $this->imageset( $mediaItem->getPreviews(), $mediaItem->getFileSystem() ) ) ?>"
									alt="<?= $enc->attr( $mediaItem->getProperties( 'title' )->first() ) ?>"
								>
								<meta itemprop="contentUrl" content="<?= $enc->attr( $this->content( 'aimeos/' . $mediaItem->getPreview(), $mediaItem->getFileSystem() ) ) ?>">
							</div>
						</noscript>
						...
						<?php foreach( $productItem->getRefItems( 'media', 'default', 'default' ) as $mediaItem ) : ?>
							<div class="media-item">
								<img class="lazy-image"
									...
									data-src="<?= $enc->attr( $this->content( 'aimeos/' . $mediaItem->getPreview(), $mediaItem->getFileSystem() ) ) ?>"
