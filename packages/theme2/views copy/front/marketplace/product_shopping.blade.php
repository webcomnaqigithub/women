@extends('base')
@section('title') Product Shopping | بازار - Bazaar @endsection
...
<div class="bigen-container-shop-data ">
	...
	<div class="breadcrumbs d-flex flex-row align-items-center ">
		<ul>
			...
			<li class="active"><a><i class="fa fa-angle-left" aria-hidden="true"></i> {{aitrans('Shops', [], 'client')}}</a></li>
		</ul>
	</div>
	</div>
	<!--  search  -->
	...
	<div class="search-shop  ">
		...
		<div>{{aitrans('result', [], 'client')}}  {{$productItems->count()}}</div>
	...
	<div class="row">
		<div class="filter-option d-none">
			<form action="{{airoute('front.product_shopping')}}" method="GET" id="product_shopping">
				<div class="sidebar">
					<!-- Elements -->
					<div class="row ">
						...
						<ul class="checkboxes">
							...
							<li class="">
								<div class="d-flex price">
									<input type="number" name="l_price" value="{{$request->l_price}}" class="input-price form-control " placeholder="من">
									<span class="px-2"> -- </span>
									<input type="number" name="h_price" value="{{$request->h_price}}" class="input-price form-control" placeholder="الى">
								</div>
							</li>
						</ul>
					</div>
