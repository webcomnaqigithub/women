                     ...
                     <div class="login-input mb-5">
                           <div class="row d-flex justify-content-center mt-2">
                              <div class="col-md-6  my-1">
                                 ...
                                 <input class="form-control" type="email" name="email" :value="old('email')" placeholder="{{aitrans('E-mail', [], 'client')}}" required autofocus>
                                 @error('email')
                           ...
                           <div class="row d-flex justify-content-center mt-2">
                              <div class="col-md-6 my-1 ">
                                 ...
                                 <input type="password" id="password-field" class="form-control" placeholder="{{aitrans('Password', [], 'client')}}" type="password" name="password" required autocomplete="current-password">
