...
<html lang="en">
   ...
   <body class="{{ $page ?? '' }} {{app()->getLocale()== 'ar' ? 'rtlcarousel' : 'ltrcarousel'}}">
      <div class="super_container"> 
                              ...
                              @elseif(Auth::check() && Auth::user()->superuser != 1)
                                 ...
                                 <li>
                                    <a href="{{airoute('front.notification', ['site' => 'default'])}}">			
                                       ...
                                       {{-- <span id="checkout_items" class="checkout_items">3</span> --}}
                                    </a>
                                 </li>
                                 <li class="mr-2">
                  ...
                  <div class="row d-flex-space-between">
                                       ...
                                       <div class="row mt-4">
                                          @foreach ($sub_categories as $item)
                                             <div class="ml-4 text-center cursor-pointer cat-tree-2" data-id="{{($item->getId())}}" data-label="{{($item->getLabel())}}">
                                                ...
                                                <h5 class="title-product-nav-bar">{{($item->getLabel())}}</h5>
                                             </div>
                                          @endforeach
                                       </div>
                                       <div class="Sub-Categories Clothes" id="subcat" style="display: none;">
                                          <hr>
                                          <h4 id="maincat-name">{{aitrans('Category', [], 'client')}}</h4>
                     ...
                     @guest
                        <div class="logo_container-mobile "> 
                           <ul class="navbar_user navbar mx-5">
                        ...
                        <div class="logo_container-mobile "> 
                           ...
                           <ul class="navbar_user float-direction">
                              ...
                              @if (Auth::guest())
                                 ...
                                 <li>
                                    <button class="btn  btn-outline-danger cursor-pointer round-20 mt-n13  entry-reg-shop">
                                    <a  href="{{airoute('mrchnt_register')}}">{{aitrans('Join as a shop', [], 'client')}}</a>
                                    </button>
                                    </a>
                                 </li>
                              @elseif(Auth::check() && Auth::user()->superuser != 1)
                                 ...
                                 <li>
                                    <a href="{{airoute('front.notification')}}">			
                                       <img src="{{asset('front/images/icon/Notification.png')}}" width="16">
                                       {{-- <span id="checkout_items" class="checkout_items">3</span> --}}
                                    </a>
                                 </li>
               ...
               <ul class="menu_top_nav">
                  ...
                  <li class="menu_item has-children">
                     ...
                     <ul class="menu_selection">
                        <li><a href="{{airoute('login', ['site' => 'default'])}}"><i class="fa fa-sign-in" aria-hidden="true"></i>Sign In</a></li>
                        <li><a href="{{airoute('mrchnt_register', ['site' => 'default'])}}"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</a></li>
                     </ul>
                  </li>
               </ul>
            </div>
         ...
         <!-- Footer -->
         <div class="footer fixed-bottom" style="z-index:unset;height: unset;">
            <div class="container">
                 ...
                 <div class="div-footer-5">
                   ...
                   <div class=" d-flex flex-row mt-10px">
                     ...
                     <ul class="l-h-li">
                        ...
                        <li><a class="a cursor-pointer"> 59-888-0593 972+</a></li>
                     </ul>
                   </div>
                 </div>
               </div>
               <div class="end-footer row d-flex-space-between pt-40" >
