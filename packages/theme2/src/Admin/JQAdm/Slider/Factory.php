...
namespace Aimeos\Admin\JQAdm\Slider;
		...
		implements \Aimeos\Admin\JQAdm\Common\Factory\Iface
{
	...
	public static function create( \Aimeos\MShop\ContextIface $context, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Slider\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Slider\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/slider/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'admin/jqadm/slider/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Slider\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'slider' );
	}
}
