		...
		implements \Aimeos\Admin\JQAdm\Common\Factory\Iface
{
	...
	public static function create( \Aimeos\MShop\ContextIface $context, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Blog\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Blog\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/blog/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'admin/jqadm/blog/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Blog\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'blog' );
	}
}
