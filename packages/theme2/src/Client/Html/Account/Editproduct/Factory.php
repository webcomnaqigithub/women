	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	...
	{
		if( $name === null ) {
			$name = $context->config()->get( 'client/html/account/editproduct/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Client\\Html\\Iface';
		$classname = '\\Aimeos\\Client\\Html\\Account\\Editproduct\\' . $name;
		...
		$client = self::addClientDecorators( $context, $client, 'editproduct' );
