	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	...
	{
		if( $name === null ) {
			$name = $context->config()->get( 'client/html/contactus/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Client\\Html\\Iface';
		$classname = '\\Aimeos\\Client\\Html\\Contactus\\' . $name;
		...
		$client = self::addClientDecorators( $context, $client, 'contactus' );
