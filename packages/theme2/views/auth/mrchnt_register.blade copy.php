                    ...
                    <form action="{{airoute('mrchnt_register')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="section1">
                            ...
                            <div class="Register-next  mt-5">
                                <a onclick="nextstep()" class="btn btn-danger cursor-pointer round-20">
                                    {{aitrans('next one', [], 'client')}}
                                </a>
                                <div class="have-account ">
                                    <span> {{aitrans('Already have an account?', [], 'client')}}</span>
                                    <a href="{{airoute('login', ['site' => 'default'])}}" class="text-danger d-block pt-1">{{aitrans('Login', [], 'client')}}</a>
                                </div>
                        ...
                        <div id="section2" >
                            ...
                            <div class="Register-next mt-5">
                                <a class="btn btn-dark cursor-pointer round-20" id="previous" style="width: 13%;">
                                    {{aitrans('Previous', [], 'client')}}
                                </a>
                                <button type="submit" class="join btn btn-dark cursor-pointer round-20">
                                    {{aitrans('joining', [], 'client')}}
                                </button>
                                <div class="Register-steps rs-2">
                                    <label>
                                        2 / 2
                                    </label>
                                </div>
