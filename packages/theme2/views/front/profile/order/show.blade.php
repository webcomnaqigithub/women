                        ...
                        <div class="col-md-12 details_user_Products Products_col"> 
                           ...
                           <div class="col-9 add_Products">
                              ...
                              @if ($product['order.base.product.statusdelivery'] == -1)
                                 <button class="button-order-refusal mr-2 refuse-oder" data-id="<?= $product->getId()?>" data-baseid="<?= $historyItems['order.base.id']?>" data-status="reject" data-toggle="modal" data-target="#order-refusal-modal" data-productid="<?= $product['order.base.product.productid']?>">
                                    رفض الطلب
                                 </button>
               ...
               <div class="modal-content  ">
                  ...
                  <div class="modal-body text-center">
                     ...
                     <div class="form-group send-masg-shop  font-weight-bold mt-5">
                        <button type="button" class="btn btn-danger" data-toggle="modal" id="confirm-refuse" data-id="{{$item['order.base.product.id']}}" data-ida="{{$item['order.base.product.baseid']}}" data-status="reject">
                        إرسال
               ...
               <div class="row ">  
                  ...
                  @foreach ($list as $item) 
                     <div class="col-md-12 details_user_Products Products_col justify-content-between"> 
                        ...
                        <div> 
                           @switch($item['order.base.product.statusdelivery'])
                              @case(-1)
      ...
      <div class="modal fade" id="order-refusal-success-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
         <div class="modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content ">
               <div class="modal-header-cust">
                  <h5 class="modal-title" id="exampleModalLongTitle">رفض الطلب</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="display: contents;">
...
@endsection
 ...
 @section('js')
   ...
   {{-- @if (auth()->user()->merchant == 1) --}}
      ...
      <script>
         $(".button-order-Cancel").click(function(e){
            e.preventDefault();
            $(this).hide();
