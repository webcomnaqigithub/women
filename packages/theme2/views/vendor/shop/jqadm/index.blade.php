...
<html lang="{{ $locale }}" dir="{{ $localeDir }}">
	<head>
		...
		<title>الرياديات الفلسطينيات</title>
	...
	<body class="dark">
		<div class="app-menu">
			...
			<div class="app-menu-end">
				<span style="margin: 0 5px 0 5px;"><a href="{{str_replace('/'. Request::get( 'locale', app()->getLocale() ), '/en', Request::getRequestUri())}}"><span><img src="/front/images/flags/en_GB.png" width="18" height="12" alt="en_GB" title="English"></span></a></span>
				<span style="margin: 0 5px 0 5px;"><a href="{{str_replace('/'. Request::get( 'locale', app()->getLocale() ), '/ar', Request::getRequestUri())}}"><span><img src="/front/images/flags/ar.png" width="18" height="12" alt="ar" title="Arabic"></span></a></li>
